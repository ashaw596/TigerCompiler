...
funct_dec_list : funct_dec funct_dec_list | /* epsilon */;
...
block_tail : block block_tail | /* epsilon*/;
block : BEGIN dec_seg stat_seq END SEMI;

dec_seg : type_dec_list var_dec_list;
type_dec_list : type_dec type_dec_list | /* epsilon */;
...
opt_prefix : val ASSIGN | /* epslion */;
stat : BREAK SEMI | RETURN expr SEMI | block_list SEMI;
...
val : ID val_tail;
val_tail : LBRACK index_expr RBRACK
...
index_expr_tail : index_expr index_oper index_expr_tail;
